...
import styles from "../../screens/Pricing/Faq/Faq.module.sass";
import Item from "../../screens/Pricing/Faq/Item";
...
const items = [
    {
      ...
      items: [
        ...
        {
          title: "What is the status of my Zeus membership?",
        },
        {
      ...
      <div className={cn("container", styles.container)}>
        <div className={styles.top}>
          ...
          <div className={styles.info}>
            Join Zeus community now to get free updates and also alot of
